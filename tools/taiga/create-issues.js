...
const issues = [
  ...
  },
  {
    ...
    description: 'Generar documentacion OpenAPI/Swagger para todos los endpoints REST del backend. Incluir:\n\n- Descripcion de cada endpoint\n- Parametros de entrada y salida\n- Codigos de respuesta\n- Ejemplos de requests/responses',
  ...
  },
  {
    ...
    description: 'Identificar y limpiar codigo duplicado en los servicios de Spring Boot. Revisar:\n\n- Repositorio base para operaciones CRUD comunes\n- Utilidades de validacion\n- Manejo de errores',
    priority: 5375923,
    status: 12536199,
